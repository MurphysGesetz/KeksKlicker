...
public class InventoryCustomizer {
    ...
    public void customizeUpgradeInventory(Player player) {
        ...
        inventory.setItem(10, new ItemBuilder(Material.WOOL).setName("§5▰§d▰ Helferlein").setLore("§7Kekse/Klick §8▰ §a+§f1", "§7Gekauft §8▰ §f" + helperAmount, (helperAmount == 100) ? "§7Preis §8▰ §cAusverkauft" : "§7Preis §8▰ §f" + plugin.getMessageFormatter().format((40 + (120 * helperAmount))) + " §6Kekse", "", (helperAmount == 100) ? "§a§l100 Verbesserungen erworben" : "§aKlicke, um die Verbesserung zu kaufen.").build());
        inventory.setItem(11, new ItemBuilder(Material.STICK).setName("§5▰§d▰ Alte Oma").setLore("§7Kekse/Klick §8▰ §a+§f3", "§7Gekauft §8▰ §f" + grandmaAmount, (grandmaAmount == 100) ? "§7Preis §8▰ §cAusverkauft" : "§7Preis §8▰ §f" + plugin.getMessageFormatter().format((150 + (360 * grandmaAmount))) + " §6Kekse", "", (grandmaAmount == 100) ? "§a§l100 Verbesserungen erworben" : "§aKlicke, um die Verbesserung zu kaufen.").build());
        inventory.setItem(12, new ItemBuilder(Material.POTATO_ITEM).setName("§5▰§d▰ Schneller Finger").setLore("§7Kekse/Klick §8▰ §a+§f10", "§7Gekauft §8▰ §f" + fingerAmount, (fingerAmount == 100) ? "§7Preis §8▰ §cAusverkauft" : "§7Preis §8▰ §f" + plugin.getMessageFormatter().format((5000 + (7500 * fingerAmount))) + " §6Kekse", "", (fingerAmount == 100) ? "§a§l100 Verbesserungen erworben" : "§aKlicke, um die Verbesserung zu kaufen.").build());
        inventory.setItem(13, new ItemBuilder(Material.EGG).setName("§5▰§d▰ Mechanisches Huhn").setLore("§7Kekse/Klick §8▰ §a+§f30", "§7Gekauft §8▰ §f" + chickenAmount, (chickenAmount == 100) ? "§7Preis §8▰ §cAusverkauft" : "§7Preis §8▰ §f" + plugin.getMessageFormatter().format((30000 + (45000 * chickenAmount))) + " §6Kekse", "", (chickenAmount == 100) ? "§a§l100 Verbesserungen erworben" : "§aKlicke, um die Verbesserung zu kaufen.").build());
        inventory.setItem(14, new ItemBuilder(Material.CLAY_BALL).setName("§5▰§d▰ MiniGun").setLore("§7Kekse/Klick §8▰ §a+§f100", "§7Gekauft §8▰ §f" + minigunAmount, (minigunAmount == 100) ? "§7Preis §8▰ §cAusverkauft" : "§7Preis §8▰ §f" + plugin.getMessageFormatter().format((100000 + (150000 * minigunAmount))) + " §6Kekse", "", (minigunAmount == 100) ? "§a§l100 Verbesserungen erworben" : "§aKlicke, um die Verbesserung zu kaufen.").build());
        inventory.setItem(15, new ItemBuilder(Material.PAPER).setName("§5▰§d▰ Profi Coder").setLore("§7Kekse/Klick §8▰ §a+§f500", "§7Gekauft §8▰ §f" + coderAmount, (coderAmount == 100) ? "§7Preis §8▰ §cAusverkauft" : "§7Preis §8▰ §f" + plugin.getMessageFormatter().format((500000 + (750000 * coderAmount))) + " §6Kekse", "", (coderAmount == 100) ? "§a§l100 Verbesserungen erworben" : "§aKlicke, um die Verbesserung zu kaufen.").build());
        inventory.setItem(16, new ItemBuilder(Material.SAPLING).setName("§5▰§d▰ Recycle Plantage").setLore("§7Kekse/Klick §8▰ §a+§f1.000", "§7Gekauft §8▰ §f" + plantationAmount, (plantationAmount == 100) ? "§7Preis §8▰ §cAusverkauft" : "§7Preis §8▰ §f" + plugin.getMessageFormatter().format((1500000 + (2500000 * plantationAmount))) + " §6Kekse", "", (plantationAmount == 100) ? "§a§l100 Verbesserungen erworben" : "§aKlicke, um die Verbesserung zu kaufen.").build());
        inventory.setItem(19, new ItemBuilder(Material.COMPASS).setName("§5▰§d▰ Turbine").setLore("§7Kekse/Klick §8▰ §a+§f5.000", "§7Gekauft §8▰ §f" + turbineAmount, (turbineAmount == 100) ? "§7Preis §8▰ §cAusverkauft" : "§7Preis §8▰ §f" + plugin.getMessageFormatter().format((10000000 + (5000000 * turbineAmount))) + " §6Kekse", "", (turbineAmount == 100) ? "§a§l100 Verbesserungen erworben" : "§aKlicke, um die Verbesserung zu kaufen.").build());
        inventory.setItem(20, new ItemBuilder(Material.BOOK).setName("§5▰§d▰ Hustler").setLore("§7Kekse/Klick §8▰ §a+§f10.000", "§7Gekauft §8▰ §f" + hustlerAmount, (hustlerAmount == 100) ? "§7Preis §8▰ §cAusverkauft" : "§7Preis §8▰ §f" + plugin.getMessageFormatter().format((25000000 + (10000000 * hustlerAmount))) + " §6Kekse", "", (hustlerAmount == 100) ? "§a§l100 Verbesserungen erworben" : "§aKlicke, um die Verbesserung zu kaufen.").build());
        inventory.setItem(21, new ItemBuilder(Material.DIAMOND).setName("§5▰§d▰ Chinafarmer").setLore("§7Kekse/Klick §8▰ §a+§f25.000", "§7Gekauft §8▰ §f" + chinaAmount, (chinaAmount == 100) ? "§7Preis §8▰ §cAusverkauft" : "§7Preis §8▰ §f" + plugin.getMessageFormatter().format((75000000 + (25000000 * chinaAmount))) + " §6Kekse", "", (chinaAmount == 100) ? "§a§l100 Verbesserungen erworben" : "§aKlicke, um die Verbesserung zu kaufen.").build());
        inventory.setItem(22, new ItemBuilder(Material.EMERALD).setName("§5▰§d▰ Atomkraftwerk").setLore("§7Kekse/Klick §8▰ §a+§f50.000", "§7Gekauft §8▰ §f" + nuclearAmount, (nuclearAmount == 100) ? "§7Preis §8▰ §cAusverkauft" : "§7Preis §8▰ §f" + plugin.getMessageFormatter().format((200000000 + (150000000 * nuclearAmount))) + " §6Kekse", "", (nuclearAmount == 100) ? "§a§l100 Verbesserungen erworben" : "§aKlicke, um die Verbesserung zu kaufen.").build());
        ...
        try {
            ...
            for (int i = 0; i < 5; i++) {
                ...
                inventory.setItem(slot, new ItemBuilder(Material.SKULL_ITEM, 1, (byte) 3).setSkullOwner(name).setName("§7» §e§l" + name + " §7«").setLore(
                        "§7Ranking §8▰ §e" + id, "§7Kekse §8▰ §e" + plugin.getMessageFormatter().format(plugin.getMySQLTableHelper().getCookies(top3Players.get(id))), "§7Erfolge §8▰ §e" + plugin.getMySQLTableHelper().getAchievments(top3Players.get(id))).build());
            }
